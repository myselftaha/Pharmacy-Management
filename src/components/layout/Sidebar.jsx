...
const NAV_SECTIONS = [
    {
        ...
        items: [
            ...
            { icon: UserCheck, label: 'Customers', path: '/customers', allowedRoles: ['Admin', 'Super Admin', 'Pharmacist', 'Salesman / Counter Staff', 'Cashier'] },
            { icon: Clock, label: 'History', path: '/history', allowedRoles: ['Admin', 'Super Admin', 'Pharmacist', 'Salesman / Counter Staff', 'Cashier'] },
            { icon: Truck, label: 'Distributors', path: '/suppliers', allowedRoles: ['Admin', 'Super Admin', 'Pharmacist', 'Store Keeper'] },
    ...
    },
    {
        section: 'GENERAL',
        items: [
            { icon: Contact, label: 'Staff', path: '/staff', requiresAdmin: true },
            { icon: ShieldCheck, label: 'Users', path: '/users', requiresAdmin: true },
