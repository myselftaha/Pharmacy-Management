    ...
    useEffect(() => {
        if (isOpen && supply) {
            const data = {
                ...
                formulaCode: supply.formulaCode || '',
                ...
                <form onSubmit={handleSubmit} className="p-6 overflow-y-auto custom-scrollbar flex-1">
                    ...
                    <div className="mb-5">
                        ...
                        <div className="grid grid-cols-4 gap-4">
                            <FormInput label="Supplier Name" value={formData.supplierName} name="supplierName" required placeholder="Select Supplier" list="suppliers-list-edit" colSpan="col-span-2" />
